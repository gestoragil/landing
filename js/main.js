...
$(document).ready(function () {
    ...
    $('.tz_submit').on('click', function (event) {
        ...
        var submit_loader = '<div class="loading text-deep-green display-inline-block margin-five no-margin-tb no-margin-right" id="loading">Enviando...</div>';
    ...
    $('.default-submit').on('click', function (event) {
        ...
        var phone = $('#' + section_id).find('[name=phone]').val();
        if(name == "")
        {
        ...
        if(phone == "")
        {
            $('#' + section_id).find('[name=phone]').addClass('tz_input_error');
            $('#loading').remove();
            tz_process = false;
        }else if(phone != ''){
        ...
        //         tz_process = false;
        //     }else{
                $('#' + section_id).find('[name=phone]').removeClass('tz_input_error');
                tz_process = true;
        //     }
        }
